...
memoryless output. Volition runs roughly half of tokens locally on
open-weight models at $0 (the exact split is printed on every receipt)
and routes synthesis to the cheapest capable cloud model
