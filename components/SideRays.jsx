...
// SideRays — animated volumetric light rays (React Bits, ogl/WebGL).
// Client-only: builds an ogl Renderer + fullscreen shader, driven on rAF and
// gated by an IntersectionObserver so it only runs while on screen.
